...
const unsupported = (feature: string): never => {
  throw new Error(`${feature} is not available in the production API yet.`)
}
...
const realPaymentService: IPaymentService = {
  ...
  verifyPayment: async (reference) => {
    ...
    return apiClient.post('/payments/verify', { provider, reference }) as any
  },
...
export async function getAuthService(): Promise<IAuthService> {
  ...
  services.auth = appConfig.enableMock ? await loadMock(() => import('./mock/authMockService')) : realAuthService as unknown as IAuthService
  return services.auth
}
export async function getProjectService(): Promise<IProjectService> {
  if (services.project) return services.project
  services.project = appConfig.enableMock ? await loadMock(() => import('./mock/projectMockService')) : realProjectService as unknown as IProjectService
  return services.project
}
export async function getStoryService(): Promise<IStoryService> {
  if (services.story) return services.story
  services.story = appConfig.enableMock ? await loadMock(() => import('./mock/storyMockService')) : realStoryService as unknown as IStoryService
...
export async function getCharacterService(): Promise<ICharacterService> {
  ...
  services.character = appConfig.enableMock ? await loadMock(() => import('./mock/characterMockService')) : realCharacterService as unknown as ICharacterService
...
export async function getSceneService(): Promise<ISceneService> {
  ...
  services.scene = appConfig.enableMock ? await loadMock(() => import('./mock/sceneMockService')) : realSceneService as unknown as ISceneService
  return services.scene
}
export async function getImageService(): Promise<IImageService> {
  if (services.image) return services.image
  services.image = appConfig.enableMock ? await loadMock(() => import('./mock/imageMockService')) : realImageService as unknown as IImageService
  return services.image
}
export async function getVoiceService(): Promise<IVoiceService> {
  if (services.voice) return services.voice
  services.voice = appConfig.enableMock ? await loadMock(() => import('./mock/voiceMockService')) : realVoiceService as unknown as IVoiceService
  return services.voice
}
export async function getVideoService(): Promise<IVideoService> {
  if (services.video) return services.video
  services.video = appConfig.enableMock ? await loadMock(() => import('./mock/videoMockService')) : realVideoService as unknown as IVideoService
...
export async function getCreditService(): Promise<ICreditService> {
  ...
  services.credit = appConfig.enableMock ? await loadMock(() => import('./mock/creditMockService')) : realCreditService as unknown as ICreditService
...
export async function getWalletService(): Promise<IWalletService> {
  ...
  services.wallet = appConfig.enableMock ? await loadMock(() => import('./mock/walletMockService')) : realWalletService as unknown as IWalletService
...
export async function getPaymentService(): Promise<IPaymentService> {
  ...
  services.payment = appConfig.enableMock ? await loadMock(() => import('./mock/paymentMockService')) : realPaymentService
...
export async function getNotificationService(): Promise<INotificationService> {
  ...
  services.notification = appConfig.enableMock ? await loadMock(() => import('./mock/notificationMockService')) : realNotificationService as unknown as INotificationService
...
export async function getAdminService(): Promise<IAdminService> {
  ...
  services.admin = appConfig.enableMock ? await loadMock(() => import('./mock/adminMockService')) : realAdminService
