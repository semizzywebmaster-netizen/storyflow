...
const videoMockService: any = {
  async list(...args: any[]) { return apiClient.get('/videos', { params: args[0] }) as any },
  async getById(...args: any[]) { return apiClient.get(`/videos/${args[0]}`) as any },
  async create(...args: any[]) { return apiClient.post('/videos', args[0]) as any },
  async update(...args: any[]) { return apiClient.put(`/videos/${args[0]}`, args[1]) as any },
  async delete(...args: any[]) { return apiClient.delete(`/videos/${args[0]}`) as any },
  // Story specific
...
export default videoMockService
