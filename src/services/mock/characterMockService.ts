...
const characterMockService: any = {
  async list(...args: any[]) { return apiClient.get('/characters', { params: args[0] }) as any },
  async getById(...args: any[]) { return apiClient.get(`/characters/${args[0]}`) as any },
  async create(...args: any[]) { return apiClient.post('/characters', args[0]) as any },
  async update(...args: any[]) { return apiClient.put(`/characters/${args[0]}`, args[1]) as any },
  async delete(...args: any[]) { return apiClient.delete(`/characters/${args[0]}`) as any },
  // Story specific
...
export default characterMockService
