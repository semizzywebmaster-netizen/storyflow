...
const creditMockService: any = {
  async list(...args: any[]) { return apiClient.get('/credits', { params: args[0] }) as any },
  async getById(...args: any[]) { return apiClient.get(`/credits/${args[0]}`) as any },
  async create(...args: any[]) { return apiClient.post('/credits', args[0]) as any },
  async update(...args: any[]) { return apiClient.put(`/credits/${args[0]}`, args[1]) as any },
  async delete(...args: any[]) { return apiClient.delete(`/credits/${args[0]}`) as any },
  // Story specific
...
export default creditMockService
