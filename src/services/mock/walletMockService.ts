...
const walletMockService: any = {
  async list(...args: any[]) { return apiClient.get('/wallets', { params: args[0] }) as any },
  async getById(...args: any[]) { return apiClient.get(`/wallets/${args[0]}`) as any },
  async create(...args: any[]) { return apiClient.post('/wallets', args[0]) as any },
  async update(...args: any[]) { return apiClient.put(`/wallets/${args[0]}`, args[1]) as any },
  async delete(...args: any[]) { return apiClient.delete(`/wallets/${args[0]}`) as any },
  // Story specific
