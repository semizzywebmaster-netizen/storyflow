...
const storyMockService: any = {
  async list(...args: any[]) { return apiClient.get('/storys', { params: args[0] }) as any },
  async getById(...args: any[]) { return apiClient.get(`/storys/${args[0]}`) as any },
  async create(...args: any[]) { return apiClient.post('/storys', args[0]) as any },
  async update(...args: any[]) { return apiClient.put(`/storys/${args[0]}`, args[1]) as any },
  async delete(...args: any[]) { return apiClient.delete(`/storys/${args[0]}`) as any },
  // Story specific
...
export default storyMockService
