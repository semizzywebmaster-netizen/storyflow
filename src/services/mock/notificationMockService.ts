...
const notificationMockService: any = {
  async list(...args: any[]) { return apiClient.get('/notifications', { params: args[0] }) as any },
  async getById(...args: any[]) { return apiClient.get(`/notifications/${args[0]}`) as any },
  async create(...args: any[]) { return apiClient.post('/notifications', args[0]) as any },
  async update(...args: any[]) { return apiClient.put(`/notifications/${args[0]}`, args[1]) as any },
  async delete(...args: any[]) { return apiClient.delete(`/notifications/${args[0]}`) as any },
  // Story specific
