...
const imageMockService: any = {
  async list(...args: any[]) { return apiClient.get('/images', { params: args[0] }) as any },
  async getById(...args: any[]) { return apiClient.get(`/images/${args[0]}`) as any },
  async create(...args: any[]) { return apiClient.post('/images', args[0]) as any },
  async update(...args: any[]) { return apiClient.put(`/images/${args[0]}`, args[1]) as any },
  async delete(...args: any[]) { return apiClient.delete(`/images/${args[0]}`) as any },
  // Story specific
...
export default imageMockService
