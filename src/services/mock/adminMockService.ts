...
const adminMockService: any = {
  async list(...args: any[]) { return apiClient.get('/admins', { params: args[0] }) as any },
  async getById(...args: any[]) { return apiClient.get(`/admins/${args[0]}`) as any },
  async create(...args: any[]) { return apiClient.post('/admins', args[0]) as any },
  async update(...args: any[]) { return apiClient.put(`/admins/${args[0]}`, args[1]) as any },
  async delete(...args: any[]) { return apiClient.delete(`/admins/${args[0]}`) as any },
  // Story specific
