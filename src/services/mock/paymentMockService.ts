...
const paymentMockService: any = {
  async list(...args: any[]) { return apiClient.get('/payments', { params: args[0] }) as any },
  async getById(...args: any[]) { return apiClient.get(`/payments/${args[0]}`) as any },
  async create(...args: any[]) { return apiClient.post('/payments', args[0]) as any },
  async update(...args: any[]) { return apiClient.put(`/payments/${args[0]}`, args[1]) as any },
  async delete(...args: any[]) { return apiClient.delete(`/payments/${args[0]}`) as any },
  // Story specific
