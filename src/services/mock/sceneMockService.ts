...
const sceneMockService: any = {
  async list(...args: any[]) { return apiClient.get('/scenes', { params: args[0] }) as any },
  async getById(...args: any[]) { return apiClient.get(`/scenes/${args[0]}`) as any },
  async create(...args: any[]) { return apiClient.post('/scenes', args[0]) as any },
  async update(...args: any[]) { return apiClient.put(`/scenes/${args[0]}`, args[1]) as any },
  async delete(...args: any[]) { return apiClient.delete(`/scenes/${args[0]}`) as any },
  // Story specific
...
export default sceneMockService
